            ...
            <div className="cognora-error-state">
              <div className="cognora-error-state__header">
                ...
                <span className="cognora-error-state__title">
                  {errorCode === "AUTHENTICATION_ERROR" || errorCode === "AUTH_FAILED"
                    ? "Authentication failed"
                    : errorCode === "RATE_LIMIT"
                    ? "Rate limit reached"
                    : errorCode === "STRUCTURED_OUTPUT_ERROR" || errorCode === "SCHEMA_ERROR" || errorCode === "VALIDATION_ERROR"
                    ? "Lesson format error"
                    : errorCode === "PROVIDER_CAPACITY" || errorCode === "CREDIT_CAPACITY_EXCEEDED"
                    ? "Capacity limit reached"
                    : errorCode === "TIMEOUT"
                    ? "Generation timed out"
                    : errorCode === "NETWORK_ERROR"
                    ? "Network connection error"
                    : errorCode === "PROVIDER_UNAVAILABLE" || errorCode === "SERVICE_UNAVAILABLE"
