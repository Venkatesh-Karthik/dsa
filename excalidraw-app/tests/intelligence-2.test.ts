...
import {
  validateTeachingQuality,
} from "../ai/quality-validator";
...
describe("Category A: Known Concepts", () => {
  it("Linked List Insertion: maintains stable entity IDs and valid pointer rewiring", () => {
    const model: ConceptModel = {
      ...
      relationships: [
        { id: "rel-1-2", sourceEntityId: "node-1", targetEntityId: "node-2", type: "next", direction: "forward" },
      ],
      states: [
        {
          stateIndex: 0,
      ...
      transformations: [
        {
          ...
          learnerObservation: "Node 20 is created without any incoming or outgoing links.",
        ...
        },
        {
          ...
          reason: "Preserve reference to the rest of the list before modifying predecessor.",
        ...
        },
        {
          ...
          learnerObservation: "Predecessor arrow redirects from Node 30 to Node 20.",
      ...
      invariants: [
        {
          id: "inv-connectivity",
          description: "All list nodes must be reachable from head without orphaned links.",
      ...
      misconceptions: [
        {
          ...
          correction: "Must point new node to successor first to avoid losing the rest of the list.",
        },
      ],
      observations: [],
    };
    ...
    // Quality validation
    const quality = validateTeachingQuality(model, "Explain linked list insertion");
  ...
  it("AVL Tree Rotation: validates rebalancing without fake steps", () => {
    const model: ConceptModel = {
      ...
      domain: "data_structures",
      objective: "Restore height balance by rotating unbalanced left-heavy subtree.",
      teachingStrategy: "STRUCTURAL_TRANSFORMATION",
      entities: [
      ...
      relationships: [
        { id: "rel-root-left", sourceEntityId: "node-root", targetEntityId: "node-left", type: "left", direction: "forward" },
        { id: "rel-left-ll", sourceEntityId: "node-left", targetEntityId: "node-ll", type: "left", direction: "forward" },
      ],
      states: [
        { stateIndex: 0, name: "Unbalanced State (BF=+2)", activeEntityIds: ["node-root", "node-left", "node-ll"], activeRelationshipIds: ["rel-root-left", "rel-left-ll"] },
        { stateIndex: 1, name: "Elevate Pivot Node 20", activeEntityIds: ["node-root", "node-left", "node-ll"], activeRelationshipIds: [] },
        { stateIndex: 2, name: "Adopt Node 30 as Right Child", activeEntityIds: ["node-root", "node-left", "node-ll"], activeRelationshipIds: [] },
      ],
      transformations: [
        {
          id: "t-avl-1",
        ...
        },
        {
          ...
          learnerObservation: "Node 20 is now root; Node 10 is left, Node 30 is right.",
...
describe("Category B: Known Concepts with Unusual Parameters", () => {
  it("Parameter Mutation: evaluates dynamic parameter mutation locally", () => {
    const model: ConceptModel = {
      ...
      relationships: [],
      states: [
        { stateIndex: 0, name: "Initial Interval [0, 4]", activeEntityIds: ["elem-0", "elem-1", "elem-2", "elem-3", "elem-4"], activeRelationshipIds: [] },
      ],
      transformations: [
        {
          id: "t-bs-1",
          ...
          reason: "Binary search tests the median element to eliminate half the search space.",
      ...
      invariants: [
        { id: "inv-sorted", description: "Array elements must remain in non-decreasing sorted order.", rule: "arr[i] <= arr[i+1]" },
      ],
      misconceptions: [],
      observations: [],
    };
    ...
    expect(mutation.semanticPrediction).toContain("triggers re-evaluation of invariants");
  });
});
...
describe("Category C: Completely Unseen Concepts", () => {
  it("Refrigerator Cooling Cycle: models thermodynamics using generic semantics", () => {
    ...
    const model: ConceptModel = {
      ...
      domain: "generic",
      objective: "Explain how thermodynamic compression, condensation, expansion, and evaporation remove heat from an interior compartment.",
      teachingStrategy: strategy,
      entities: [
        { id: "comp-compressor", type: "Component", label: "Compressor", semanticRole: "work_input", properties: { shape: "rectangle" } },
        { id: "comp-condenser", type: "Component", label: "Condenser Coils", semanticRole: "heat_rejection", properties: { shape: "rectangle" } },
        { id: "comp-expansion-valve", type: "Component", label: "Expansion Valve", semanticRole: "pressure_drop", properties: { shape: "diamond" } },
        { id: "comp-evaporator", type: "Component", label: "Evaporator Coils", semanticRole: "heat_absorption", properties: { shape: "rectangle" } },
        { id: "refrigerant-fluid", type: "Resource", label: "Refrigerant", semanticRole: "working_fluid", state: "low_pressure_gas" },
      ],
      relationships: [
        { id: "rel-c-to-c", sourceEntityId: "comp-compressor", targetEntityId: "comp-condenser", type: "sendsTo", direction: "forward", label: "High-P Gas" },
        { id: "rel-c-to-v", sourceEntityId: "comp-condenser", targetEntityId: "comp-expansion-valve", type: "sendsTo", direction: "forward", label: "High-P Liquid" },
        { id: "rel-v-to-e", sourceEntityId: "comp-expansion-valve", targetEntityId: "comp-evaporator", type: "sendsTo", direction: "forward", label: "Low-P Liquid/Gas" },
        { id: "rel-e-to-c", sourceEntityId: "comp-evaporator", targetEntityId: "comp-compressor", type: "sendsTo", direction: "forward", label: "Low-P Gas" },
      ],
      states: [
        { stateIndex: 0, name: "Compression Stage", activeEntityIds: ["comp-compressor", "comp-condenser", "comp-expansion-valve", "comp-evaporator", "refrigerant-fluid"], activeRelationshipIds: ["rel-c-to-c", "rel-c-to-v", "rel-v-to-e", "rel-e-to-c"] },
        { stateIndex: 1, name: "Condensation Stage", activeEntityIds: ["comp-compressor", "comp-condenser", "comp-expansion-valve", "comp-evaporator", "refrigerant-fluid"], activeRelationshipIds: ["rel-c-to-c", "rel-c-to-v", "rel-v-to-e", "rel-e-to-c"] },
        { stateIndex: 2, name: "Expansion Stage", activeEntityIds: ["comp-compressor", "comp-condenser", "comp-expansion-valve", "comp-evaporator", "refrigerant-fluid"], activeRelationshipIds: ["rel-c-to-c", "rel-c-to-v", "rel-v-to-e", "rel-e-to-c"] },
        { stateIndex: 3, name: "Evaporation Stage", activeEntityIds: ["comp-compressor", "comp-condenser", "comp-expansion-valve", "comp-evaporator", "refrigerant-fluid"], activeRelationshipIds: ["rel-c-to-c", "rel-c-to-v", "rel-v-to-e", "rel-e-to-c"] },
      ],
      transformations: [
        {
          id: "t-ref-1",
          ...
          reason: "Mechanical work raises temperature above ambient room temperature.",
          learnerObservation: "Refrigerant enters compressor and exits at high temperature and pressure.",
          consequence: "Refrigerant can now reject heat to the warmer kitchen environment.",
          whatChanged: "Refrigerant state: low-pressure gas -> high-pressure superheated vapor",
        ...
        },
        {
          ...
          fromStateIndex: 1,
          toStateIndex: 2,
          action: "Dissipate heat to room as refrigerant condenses into high-pressure liquid",
          reason: "Refrigerant is hotter than room air, driving heat transfer outwards.",
          learnerObservation: "Heat radiates out the back of the refrigerator.",
          consequence: "Fluid becomes room-temperature liquid under high pressure.",
          whatChanged: "Refrigerant state: high-pressure vapor -> high-pressure liquid",
        ...
        },
        {
          ...
          fromStateIndex: 2,
          toStateIndex: 3,
          action: "Constrict flow through expansion orifice, causing abrupt pressure and temperature drop",
          reason: "Joule-Thomson expansion causes rapid chilling.",
          learnerObservation: "Refrigerant temperature plummets below the temperature of the fridge compartment.",
          consequence: "Fluid is now cold enough to absorb heat from inside food compartments.",
          whatChanged: "Pressure drop: high-pressure liquid -> cold low-pressure mixture",
        ...
        },
        {
          ...
          fromStateIndex: 3,
          toStateIndex: 0,
          action: "Absorb heat from the interior food compartment, boiling refrigerant into vapor",
          reason: "Cold coils absorb thermal energy from inside the refrigerator.",
          learnerObservation: "Interior air cools as heat moves into the refrigerant.",
          consequence: "Completes the closed cycle and returns vapor to the compressor.",
      ...
      invariants: [
        {
          id: "inv-first-law",
          description: "Conservation of energy: Net heat absorbed + net work input = Net heat rejected.",
      ...
      misconceptions: [
        {
          ...
          correction: "Refrigerators do not create cold; they pump thermal energy out of the interior and exhaust it into the room.",
        },
      ],
      observations: [],
    };
    ...
    expect(inspected?.incomingConnections[0].fromId).toBe("comp-expansion-valve");
  ...
  it("Compiler Pipeline: models lexing -> parsing -> AST -> codegen as a pipeline", () => {
    const prompt = "Explain how a compiler transforms source code into machine code";
    const intent = classifyDetailedIntent(prompt);
    const strategy = selectTeachingStrategy(intent.targetConcept, intent);
    ...
    const model: ConceptModel = {
      ...
      domain: "generic",
      objective: "Trace the multi-stage transformation from source code text to native executable instructions.",
      teachingStrategy: strategy,
      entities: [
        { id: "stage-source", type: "GenericEntity", label: "Source Code Text", value: 'let x = 10 + y;' },
        { id: "stage-tokens", type: "GenericEntity", label: "Token Stream", value: '[LET, ID(x), EQUALS, NUM(10), PLUS, ID(y)]' },
        { id: "stage-ast", type: "GenericEntity", label: "Abstract Syntax Tree", value: 'VarDecl(x, BinaryExpr(+, 10, y))' },
        { id: "stage-ir", type: "GenericEntity", label: "Intermediate Representation", value: '%1 = add i32 10, %y' },
        { id: "stage-asm", type: "GenericEntity", label: "Machine Code", value: 'MOV EAX, 10; ADD EAX, [EBP-4]' },
      ],
      relationships: [
        { id: "rel-1", sourceEntityId: "stage-source", targetEntityId: "stage-tokens", type: "transformsInto", direction: "forward", label: "Lexical Analysis" },
        { id: "rel-2", sourceEntityId: "stage-tokens", targetEntityId: "stage-ast", type: "transformsInto", direction: "forward", label: "Parsing" },
        { id: "rel-3", sourceEntityId: "stage-ast", targetEntityId: "stage-ir", type: "transformsInto", direction: "forward", label: "Type Check & IR Gen" },
        { id: "rel-4", sourceEntityId: "stage-ir", targetEntityId: "stage-asm", type: "transformsInto", direction: "forward", label: "Code Generation" },
      ],
      states: [
        { stateIndex: 0, name: "Raw Source", activeEntityIds: ["stage-source"], activeRelationshipIds: [] },
        { stateIndex: 1, name: "Tokenized", activeEntityIds: ["stage-source", "stage-tokens"], activeRelationshipIds: ["rel-1"] },
        { stateIndex: 2, name: "Synthesized AST", activeEntityIds: ["stage-tokens", "stage-ast"], activeRelationshipIds: ["rel-2"] },
      ],
      transformations: [
        {
          id: "t-comp-1",
          ...
          reason: "Discard whitespace and group characters into meaningful syntax atoms.",
          learnerObservation: "Raw string is converted into a linear sequence of typed tokens.",
        ...
        },
        {
          ...
          fromStateIndex: 1,
          toStateIndex: 2,
          action: "Parser applies grammar productions to build an Abstract Syntax Tree",
          reason: "Discovers operator precedence and structural semantics.",
          learnerObservation: "Linear token sequence becomes a hierarchical tree of operations.",
          consequence: "Represents semantic meaning independent of concrete syntax.",
      ...
      invariants: [
        {
          ...
          description: "Every stage must strictly preserve the computational semantics of the original program.",
  ...
  it("DNS Resolution: models distributed state machine or causal flow without DNS-specific code", () => {
    ...
    const dependencies = inferConceptDependencies("DNS Resolution", "STATE_MACHINE");
...
describe("Property-Based Architectural Invariants", () => {
  it("Property 1: Anti-Fake-Step rejects consecutive identical states with zero operations", () => {
    const fakeModel: ConceptModel = {
      ...
      relationships: [],
      states: [
        { stateIndex: 0, name: "S1", activeEntityIds: ["n1"], activeRelationshipIds: [] },
        { stateIndex: 1, name: "S2", activeEntityIds: ["n1"], activeRelationshipIds: [] },
      ],
      transformations: [
        {
          id: "t1",
    ...
    expect(quality.issues.some((i) => i.code === "FAKE_STEP_DETECTED")).toBe(true);
  });
  ...
  it("Property 2: Quality validator catches dangling relationship targets", () => {
    const brokenModel: ConceptModel = {
      ...
      relationships: [
        { id: "rel-broken", sourceEntityId: "node-existing", targetEntityId: "non-existent-node", type: "pointsTo", direction: "forward" },
      ],
      states: [],
      transformations: [
        {
    ...
    expect(quality.valid).toBe(false);
    expect(quality.issues.some((i) => i.code === "DANGLING_RELATIONSHIP_TARGET")).toBe(true);
  });
  ...
  it("Property 3: Non-invasive Learner Model detects confusion without personal profiling", () => {
    ...
    expect(session.lastConfusionAssessment?.recommendedAdaptation).toBe("simplify");
  ...
  it("Property 4: Multi-dimensional intent distinguishes between compare, what-if, code, and practice", () => {
    const comparisonIntent = classifyDetailedIntent("Compare BFS and DFS for finding shortest paths in unweighted graphs");
    ...
    const whatIfIntent = classifyDetailedIntent("What happens if we reverse the pointer directions in a circular list?");
    ...
    const practiceIntent = classifyDetailedIntent("Quiz me on Dijkstra edge relaxation");
    ...
    const codeIntent = classifyDetailedIntent("Show the code implementation of QuickSort partition");
  ...
  it("Property 5: Dynamic teaching depth scales proportionally with requested depth", () => {
    const quickIntent = classifyDetailedIntent("Give me a quick overview of HTTP GET");
    expect(determineTeachingDepth(quickIntent, 2)).toBeLessThanOrEqual(3);

    const deepIntent = classifyDetailedIntent("Provide a deep and exhaustive step by step walkthrough of TCP Handshake");
