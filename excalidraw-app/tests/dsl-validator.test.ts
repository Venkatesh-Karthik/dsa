  ...
  describe("Dynamic Multi-Step Teaching Validation", () => {
      ...
      const response = {
        ...
        steps: [
          ...
          },
          {
            ...
            explanation: "Compute mid = (0 + 4) / 2 = 2. Check value at arr[2].",
    ...
    it("normalizes and validates responses with arbitrary raw colors and placements", () => {
      ...
      const rawResponse = {
        ...
        message: "A floating window moves independently and remains above content.",
        steps: [
          {
            id: "step-1",
            step_number: 1,
            title: "Independent Window Layer",
            explanation: "The window floats above the desktop and other application windows.",
