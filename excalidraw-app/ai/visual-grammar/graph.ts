...
import type { CreateGraphAction, ArrayElementHighlight, SemanticColor } from "../visual-dsl";
...
function highlightToColor(h?: ArrayElementHighlight | SemanticColor): SemanticColor | undefined {
  switch (h) {
    case "low":
