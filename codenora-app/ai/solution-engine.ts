    ...
    switch (strategy) {
      ...
      case "transform":
        steps.push({
          ...
          action:
            "Establish initial semantic entities, relationships, and invariants",
        ...
        steps.push({
          ...
          action:
            "Execute primary state transformation and update dependent properties",
        ...
        steps.push({
          ...
          action:
            "Validate invariant rules, settle final state, and verify objective satisfaction",
          rationale:
            "Demonstrates final convergence and guarantees correctness",
      ...
      case "compare":
        steps.push({
          ...
          action:
            "Establish properties, constraints, and behavior of First Option",
        ...
        steps.push({
          ...
          action:
            "Establish properties, constraints, and behavior of Alternative Option",
        ...
        steps.push({
          ...
          action:
            "Synthesize comparative tradeoffs, complexity, and optimal use cases",
      ...
      case "prove":
        steps.push({
          ...
          action:
            "Define given quantities, invariant assumptions, and initial equations",
      ...
      default:
        steps.push({
          ...
          action:
            "Decompose concept into fundamental semantic entities and relationships",
        ...
        steps.push({
          ...
          action:
            "Illustrate interactions, message flows, or property evolutions",
