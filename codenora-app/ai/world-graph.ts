...
export class SemanticWorldGraph {
   ...
   */
  public static fromAuthoritativeModel(
...
export class WhyEngine {
  ...
  public static traceCausalReasoning(
    ...
    const inv = model.invariants.find(
      (i) =>
    ...
    const causalChainSummary = `Because ${primaryCause}, step '${
      transformation.title
    }' was executed. This preserves invariant: "${
      inv?.statement || "Structural integrity"
    }" and ${goalAdvanced.toLowerCase()}.`;
