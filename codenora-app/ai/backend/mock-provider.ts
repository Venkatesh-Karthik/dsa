  ...
  private getAVLSteps(): TeachingStep[] {
    return [
      ...
      },
      {
        ...
        step_number: 3,
        title:
          "Case 3: Left-Right (LR) Heavy — Double Rotation (Left then Right)",
        explanation:
      ...
      },
      {
        ...
        step_number: 4,
        title:
          "Case 4: Right-Left (RL) Heavy — Double Rotation (Right then Left)",
        explanation:
    ...
    if (lower.includes("60")) {
      const visual_actions: VisualAction[] = [
        ...
        },
        {
          ...
          target: "bsa-3",
          color: "neutral",
          message: "40 < 60: Left half eliminated",
        },
        // Highlight the found target
        {
          ...
          target: "bsa-5",
          color: "success",
          message: "Found! 60 matches target",
        },
