...
export function mapSemanticStateToNodeTokens(highlight?: string) {
  switch (highlight) {
    case "target":
      return TOKENS.NODE.TARGET;
    case "found":
    case "current":
      return TOKENS.NODE.CURRENT;
    case "visited":
      return TOKENS.NODE.VISITED;
    case "path":
      return TOKENS.NODE.IN_PATH;
    case "eliminated":
      return {
        ...TOKENS.NODE.DEFAULT,
        fill: PALETTE.slate100,
        textPrimary: PALETTE.slate300,
      };
    case "failure":
    case "failed":
    case "error":
...
export function mapSemanticStateToEdgeTokens(highlight?: string) {
  switch (highlight) {
    case "path":
      return TOKENS.EDGE.IN_PATH;
    case "visited":
      return TOKENS.EDGE.VISITED;
    case "active":
      return TOKENS.EDGE.ACTIVE;
    case "failure":
    case "failed":
    case "error":
