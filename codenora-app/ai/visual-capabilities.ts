...
// ============================================================================
// Canonical Visual Capability Tokens (Cognora Universal Capability Registry)
// ============================================================================

export const CAN_RENDER_STRUCTURE = "CAN_RENDER_STRUCTURE";
export const CAN_RENDER_HIERARCHY = "CAN_RENDER_HIERARCHY";
export const CAN_RENDER_TREE = "CAN_RENDER_TREE";
export const CAN_RENDER_GRAPH = "CAN_RENDER_GRAPH";
export const CAN_RENDER_ARRAY = "CAN_RENDER_ARRAY";
export const CAN_RENDER_TABLE = "CAN_RENDER_TABLE";
export const CAN_RENDER_MATRIX = "CAN_RENDER_MATRIX";
export const CAN_RENDER_SEQUENCE = "CAN_RENDER_SEQUENCE";
export const CAN_RENDER_PROCESS = "CAN_RENDER_PROCESS";
export const CAN_RENDER_STATE = "CAN_RENDER_STATE";
export const CAN_RENDER_STATE_TRANSITION = "CAN_RENDER_STATE_TRANSITION";
export const CAN_RENDER_TIMELINE = "CAN_RENDER_TIMELINE";
export const CAN_RENDER_CYCLE = "CAN_RENDER_CYCLE";
export const CAN_RENDER_COMPARISON = "CAN_RENDER_COMPARISON";
export const CAN_RENDER_BEFORE_AFTER = "CAN_RENDER_BEFORE_AFTER";
export const CAN_RENDER_CAUSALITY = "CAN_RENDER_CAUSALITY";
export const CAN_RENDER_DATA_FLOW = "CAN_RENDER_DATA_FLOW";
export const CAN_RENDER_INFORMATION_FLOW = "CAN_RENDER_INFORMATION_FLOW";
export const CAN_RENDER_NETWORK = "CAN_RENDER_NETWORK";
export const CAN_RENDER_ACTOR = "CAN_RENDER_ACTOR";
export const CAN_RENDER_MESSAGE = "CAN_RENDER_MESSAGE";
export const CAN_RENDER_REQUEST = "CAN_RENDER_REQUEST";
export const CAN_RENDER_RESPONSE = "CAN_RENDER_RESPONSE";
export const CAN_RENDER_EQUATION = "CAN_RENDER_EQUATION";
export const CAN_RENDER_VECTOR = "CAN_RENDER_VECTOR";
export const CAN_RENDER_POINT = "CAN_RENDER_POINT";
export const CAN_RENDER_CURVE = "CAN_RENDER_CURVE";
export const CAN_RENDER_MEMORY = "CAN_RENDER_MEMORY";
export const CAN_RENDER_POINTER = "CAN_RENDER_POINTER";
export const CAN_RENDER_REFERENCE = "CAN_RENDER_REFERENCE";
export const CAN_RENDER_RANGE = "CAN_RENDER_RANGE";
export const CAN_RENDER_PATH = "CAN_RENDER_PATH";
export const CAN_RENDER_HIGHLIGHT = "CAN_RENDER_HIGHLIGHT";
export const CAN_RENDER_TRANSFORMATION = "CAN_RENDER_TRANSFORMATION";
export const CAN_RENDER_GROUP = "CAN_RENDER_GROUP";
export const CAN_RENDER_CONTAINER = "CAN_RENDER_CONTAINER";
export const CAN_RENDER_LABEL = "CAN_RENDER_LABEL";
export const CAN_RENDER_ANNOTATION = "CAN_RENDER_ANNOTATION";
export const CAN_RENDER_CODE = "CAN_RENDER_CODE";
export const CAN_RENDER_SPATIAL_RELATIONSHIP =
  "CAN_RENDER_SPATIAL_RELATIONSHIP";

export type VisualCapabilityToken =
  | typeof CAN_RENDER_STRUCTURE
  | typeof CAN_RENDER_HIERARCHY
  | typeof CAN_RENDER_TREE
  | typeof CAN_RENDER_GRAPH
  | typeof CAN_RENDER_ARRAY
  | typeof CAN_RENDER_TABLE
  | typeof CAN_RENDER_MATRIX
  | typeof CAN_RENDER_SEQUENCE
  | typeof CAN_RENDER_PROCESS
  | typeof CAN_RENDER_STATE
  | typeof CAN_RENDER_STATE_TRANSITION
  | typeof CAN_RENDER_TIMELINE
  | typeof CAN_RENDER_CYCLE
  | typeof CAN_RENDER_COMPARISON
  | typeof CAN_RENDER_BEFORE_AFTER
  | typeof CAN_RENDER_CAUSALITY
  | typeof CAN_RENDER_DATA_FLOW
  | typeof CAN_RENDER_INFORMATION_FLOW
  | typeof CAN_RENDER_NETWORK
  | typeof CAN_RENDER_ACTOR
  | typeof CAN_RENDER_MESSAGE
  | typeof CAN_RENDER_REQUEST
  | typeof CAN_RENDER_RESPONSE
  | typeof CAN_RENDER_EQUATION
  | typeof CAN_RENDER_VECTOR
  | typeof CAN_RENDER_POINT
  | typeof CAN_RENDER_CURVE
  | typeof CAN_RENDER_MEMORY
  | typeof CAN_RENDER_POINTER
  | typeof CAN_RENDER_REFERENCE
  | typeof CAN_RENDER_RANGE
  | typeof CAN_RENDER_PATH
  | typeof CAN_RENDER_HIGHLIGHT
  | typeof CAN_RENDER_TRANSFORMATION
  | typeof CAN_RENDER_GROUP
  | typeof CAN_RENDER_CONTAINER
  | typeof CAN_RENDER_LABEL
  | typeof CAN_RENDER_ANNOTATION
  | typeof CAN_RENDER_CODE
  | typeof CAN_RENDER_SPATIAL_RELATIONSHIP;

export const ALL_CAN_RENDER_CAPABILITIES: readonly VisualCapabilityToken[] = [
  CAN_RENDER_STRUCTURE,
  CAN_RENDER_HIERARCHY,
  CAN_RENDER_TREE,
  CAN_RENDER_GRAPH,
  CAN_RENDER_ARRAY,
  CAN_RENDER_TABLE,
  ...
  CAN_RENDER_PROCESS,
  CAN_RENDER_STATE,
  CAN_RENDER_STATE_TRANSITION,
  CAN_RENDER_TIMELINE,
  CAN_RENDER_CYCLE,
  CAN_RENDER_COMPARISON,
  CAN_RENDER_BEFORE_AFTER,
  CAN_RENDER_CAUSALITY,
  CAN_RENDER_DATA_FLOW,
  CAN_RENDER_INFORMATION_FLOW,
  CAN_RENDER_NETWORK,
  CAN_RENDER_ACTOR,
  CAN_RENDER_MESSAGE,
  CAN_RENDER_REQUEST,
  ...
  CAN_RENDER_MEMORY,
  CAN_RENDER_POINTER,
  CAN_RENDER_REFERENCE,
  CAN_RENDER_RANGE,
  CAN_RENDER_PATH,
  CAN_RENDER_HIGHLIGHT,
  CAN_RENDER_TRANSFORMATION,
  CAN_RENDER_GROUP,
  CAN_RENDER_CONTAINER,
  CAN_RENDER_LABEL,
  CAN_RENDER_ANNOTATION,
  CAN_RENDER_CODE,
  CAN_RENDER_SPATIAL_RELATIONSHIP,
];
...
export class VisualCapabilityRegistry {
  ...
  /**
   * Checks whether a canonical visual capability token is supported by the registry.
   */
  public canRender(token: VisualCapabilityToken): boolean {
    return ALL_CAN_RENDER_CAPABILITIES.includes(token);
  }

  /**
   * Maps a CAN_RENDER_* token to matching registered visual capabilities.
   */
  public getCapabilitiesForToken(
    token: VisualCapabilityToken,
  ): VisualCapability[] {
    switch (token) {
      case CAN_RENDER_TREE:
      case CAN_RENDER_HIERARCHY:
        return [this.get("Tree"), this.get("Node")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_GRAPH:
      case CAN_RENDER_NETWORK:
        return [this.get("Graph"), this.get("Node")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_ARRAY:
      case CAN_RENDER_SEQUENCE:
        return [this.get("Array"), this.get("Cell")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_TABLE:
        return [this.get("Table"), this.get("Record")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_MATRIX:
        return [this.get("Matrix")].filter(Boolean) as VisualCapability[];
      case CAN_RENDER_PROCESS:
        return [this.get("Process"), this.get("Stage")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_STATE:
      case CAN_RENDER_STATE_TRANSITION:
        return [this.get("State")].filter(Boolean) as VisualCapability[];
      case CAN_RENDER_TIMELINE:
        return [this.get("Timeline"), this.get("Stage")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_CYCLE:
        return [this.get("Cycle"), this.get("Node")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_ACTOR:
        return [
          this.get("Actor"),
          this.get("Client"),
          this.get("Server"),
        ].filter(Boolean) as VisualCapability[];
      case CAN_RENDER_MESSAGE:
      case CAN_RENDER_REQUEST:
      case CAN_RENDER_RESPONSE:
        return [this.get("Message")].filter(Boolean) as VisualCapability[];
      case CAN_RENDER_EQUATION:
        return [this.get("Equation")].filter(Boolean) as VisualCapability[];
      case CAN_RENDER_VECTOR:
      case CAN_RENDER_POINT:
      case CAN_RENDER_CURVE:
        return [
          this.get("Particle"),
          this.get("Ray"),
          this.get("Object"),
        ].filter(Boolean) as VisualCapability[];
      case CAN_RENDER_MEMORY:
        return [
          this.get("MemoryBlock"),
          this.get("StackFrame"),
          this.get("CallFrame"),
        ].filter(Boolean) as VisualCapability[];
      case CAN_RENDER_POINTER:
      case CAN_RENDER_REFERENCE:
        return [this.get("Pointer"), this.get("Relationship")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_CONTAINER:
      case CAN_RENDER_GROUP:
        return [this.get("Container"), this.get("Group")].filter(
          Boolean,
        ) as VisualCapability[];
      case CAN_RENDER_ANNOTATION:
      case CAN_RENDER_LABEL:
      case CAN_RENDER_HIGHLIGHT:
        return [
          this.get("Annotation"),
          this.get("Callout"),
          this.get("Badge"),
        ].filter(Boolean) as VisualCapability[];
      case CAN_RENDER_CODE:
        return [this.get("Panel")].filter(Boolean) as VisualCapability[];
      default:
        return [this.get("GenericEntity") || this.get("Node")!].filter(
          Boolean,
        ) as VisualCapability[];
    }
  }
  ...
  public findMatching(query: string): VisualCapability {
    ...
    if (
      /\b(callframe|callstack|activation|activation frame|call stack|stackframe)\b/i.test(
        q,
      )
    ) {
    ...
    if (
      /\b(message|packet|syn|ack|payload|signal|token)\b/i.test(q) ||
      (/\bframe\b/i.test(q) && !/\b(call|stack|activation)\b/i.test(q))
    ) {
  ...
  private registerFoundationalCapabilities(): void {
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Atomic discrete semantic entity or component in a graph, system, or topology.",
      supportedProperties: [
        "label",
        "value",
        "state",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(
          64,
          Math.min(180, (String(c?.label || c?.value || "").length + 2) * 10),
        ),
        height: 64,
      }),
      ...
      connectorCapabilities: {
        canBeSource: true,
        canBeTarget: true,
        supportedRoutings: ["straight", "curved", "elbowed"],
      },
      accessibilityLabel: (e) =>
        `Node ${e?.label || e?.id || ""}: ${e?.value || ""}`,
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Universal foundational entity fallback when no specialized visual capability matches.",
      supportedProperties: [
        "label",
        "value",
        "state",
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Bounded spatial enclosure grouping related sub-entities, subsystems, or execution scopes.",
      ...
      connectorCapabilities: {
        canBeSource: true,
        canBeTarget: true,
        supportedRoutings: ["elbowed", "straight"],
      },
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Logical grouping of elements that share semantic coordination or lifecycle.",
      ...
      connectorCapabilities: {
        canBeSource: true,
        canBeTarget: true,
        supportedRoutings: ["straight", "elbowed"],
      },
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Structured informational card with title, property fields, and status badges.",
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Dedicated side or bottom display panel presenting technical metrics or live code.",
      supportedProperties: ["title", "content", "language"],
      layoutRequirements: {
        preferredLayout: "linear",
        minWidth: 260,
        minHeight: 140,
        resizable: true,
      },
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Densely coupled collection of nodes or components representing a sub-network or module.",
      ...
      dynamicSizingRules: (c) => ({
        width: 120 + (c?.count || 3) * 20,
        height: 120 + (c?.count || 3) * 20,
      }),
      animationCapabilities: ["CREATE", "REMOVE", "PULSE", "HIGHLIGHT"],
      connectorCapabilities: {
        canBeSource: true,
        canBeTarget: true,
        supportedRoutings: ["curved", "straight"],
      },
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Hierarchical parent-child tree data structure or taxonomy.",
      supportedProperties: [
        "rootId",
        "branchingFactor",
        "levelGap",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(200, (c?.leavesCount || 2) * 80),
        height: (c?.depth || 2) * 100,
      }),
      animationCapabilities: ["CREATE", "REMOVE", "MOVE", "BRANCH", "MERGE"],
      connectorCapabilities: {
        canBeSource: true,
        canBeTarget: true,
        supportedRoutings: ["straight", "curved"],
      },
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Interconnected network of vertices and directed or undirected relationships.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(240, (c?.nodeCount || 4) * 60),
        height: Math.max(200, (c?.nodeCount || 4) * 50),
      }),
      animationCapabilities: [
        "CREATE",
        "REMOVE",
      ...
      accessibilityLabel: (e) =>
        `Graph network with ${e?.nodeCount || 0} nodes`,
    });
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Contiguous sequence of indexed slots representing sequential memory or buffer cells.",
      supportedProperties: [
        "length",
        "cellWidth",
        "cellHeight",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(160, (c?.length || 4) * 64),
        height: 70,
      }),
      animationCapabilities: [
        "CREATE",
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "2D grid of values or mathematical elements indexed by row and column.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(140, (c?.cols || 3) * 50),
        height: Math.max(140, (c?.rows || 3) * 50),
      }),
      animationCapabilities: ["CREATE", "REMOVE", "MUTATE", "HIGHLIGHT"],
      connectorCapabilities: {
        canBeSource: true,
        canBeTarget: true,
        supportedRoutings: ["straight"],
      },
    ...
    this.register({
      ...
      category: "structural",
      semanticMeaning:
        "Multi-row and multi-column visual grid organizing independent or parallel items.",
    ...
    this.register({
      ...
      dynamicSizingRules: (c) => ({
        width: 120,
        height: Math.max(100, (c?.itemCount || 2) * 50),
      }),
    ...
    this.register({
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(160, (c?.itemCount || 3) * 80),
        height: 50,
      }),
      animationCapabilities: ["CREATE", "REMOVE", "MOVE"],
      connectorCapabilities: {
    ...
    this.register({
      ...
      semanticMeaning:
        "Directed directional arrow indicating transfer, dependency, cause, or invocation.",
      supportedProperties: [
        "label",
        "weight",
        "color",
      ...
      connectorCapabilities: {
        canBeSource: false,
        canBeTarget: false,
        supportedRoutings: ["straight", "curved", "elbowed", "flow"],
      },
      accessibilityLabel: (e) =>
        `Directed connection from ${e?.source || ""} to ${e?.target || ""}${
          e?.label ? ` labeled ${e.label}` : ""
        }`,
    });
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Symmetric, bidirectional, or undirected relationship link between entities.",
      ...
      accessibilityLabel: (e) =>
        `Undirected connection between ${e?.source || ""} and ${
          e?.target || ""
        }`,
    });
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Two-way mutual communication or bidirectional link between entities.",
      ...
      accessibilityLabel: (e) =>
        `Two-way connection between ${e?.source || ""} and ${e?.target || ""}`,
    });
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Prerequisite dependency edge indicating that one entity requires another.",
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Loose structural or logical association between entities.",
      ...
      accessibilityLabel: (e) =>
        `Association between ${e?.source || ""} and ${e?.target || ""}`,
    });
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Parent-child structural inheritance or subordination link.",
      ...
      accessibilityLabel: (e) =>
        `${e?.source || ""} is parent of ${e?.target || ""}`,
    });
    ...
    this.register({
      ...
      connectorCapabilities: {
        canBeSource: false,
        canBeTarget: false,
        supportedRoutings: ["curved", "elbowed"],
      },
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Exclusive ownership or lifecycle management relationship.",
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Directional stream or continuous flow of items, energy, or data.",
      supportedProperties: ["rate", "direction", "medium"],
      layoutRequirements: {
        preferredLayout: "sequence",
        minWidth: 50,
        minHeight: 20,
        resizable: true,
      },
      ...
      accessibilityLabel: (e) =>
        `Flow from ${e?.source || ""} to ${e?.target || ""}`,
    });
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Discrete data transmission or message stream between computing nodes.",
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Execution transfer, call return, or algorithmic sequencing.",
      ...
      connectorCapabilities: {
        canBeSource: false,
        canBeTarget: false,
        supportedRoutings: ["elbowed", "curved"],
      },
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Explicit causal dependency indicating that event A caused event B.",
    ...
    this.register({
      ...
      category: "relationships",
      semanticMeaning:
        "Strict temporal ordering connector between consecutive milestones.",
    ...
    this.register({
      ...
      semanticMeaning:
        "Autonomous active participant, client, user, peer, or agent in a protocol or workflow.",
      supportedProperties: ["name", "role", "avatar", "highlight"],
      layoutRequirements: {
        preferredLayout: "swimlane",
        minWidth: 100,
        minHeight: 80,
        resizable: true,
      },
      dynamicSizingRules: (c) => ({
        width: Math.max(100, String(c?.name || "Actor").length * 11 + 30),
        height: 80,
      }),
      animationCapabilities: [
        "CREATE",
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Client-side computing agent initiating requests or interactions across a boundary.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(120, String(c?.name || "Client").length * 11 + 30),
        height: 70,
      }),
      animationCapabilities: [
        "CREATE",
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Server-side or host computing entity processing requests and serving responses.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(120, String(c?.name || "Server").length * 11 + 30),
        height: 70,
      }),
      animationCapabilities: [
        "CREATE",
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Hardware unit, sensor, actuator, or peripheral endpoint.",
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Modular software component, sub-routine, or service module.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(110, String(c?.name || "Component").length * 10),
        height: 65,
      }),
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Transient communication message, payload, or protocol packet in transit.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(
          70,
          String(c?.payload || c?.label || "Msg").length * 9 + 20,
        ),
        height: 34,
      }),
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Discrete network packet with headers, sequence numbers, and payload.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(80, String(c?.label || "Packet").length * 9 + 24),
        height: 36,
      }),
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Outbound request message seeking data or remote state mutation.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(80, String(c?.method || "GET").length * 10 + 40),
        height: 36,
      }),
      animationCapabilities: ["TRANSFER", "CREATE", "REMOVE"],
      connectorCapabilities: {
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Inbound or return message fulfilling a preceding request.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(80, String(c?.statusCode || "200 OK").length * 9 + 30),
        height: 36,
      }),
      animationCapabilities: ["TRANSFER", "CREATE", "REMOVE"],
      connectorCapabilities: {
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Instantaneous control signal, trigger, interrupt, or pulse.",
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Observable state occurrence or event notification emitted by a component.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(80, String(c?.eventName || "Event").length * 9 + 20),
        height: 36,
      }),
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Communication conduit or FIFO queue mediating communication between actors.",
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Active session connection or socket boundary between two endpoints.",
    ...
    this.register({
      ...
      category: "interaction",
      semanticMeaning:
        "Security boundary, network subnet boundary, or physical medium interface.",
      supportedProperties: ["boundaryName", "mediumLeft", "mediumRight"],
      layoutRequirements: {
        preferredLayout: "coordinate",
        minWidth: 200,
        minHeight: 2,
        resizable: true,
      },
    ...
    this.register({
      ...
      category: "state",
      semanticMeaning:
        "Discrete state node in a finite state machine, lifecycle, or protocol.",
      supportedProperties: [
        "stateName",
        "isInitial",
        "isTerminal",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(
          80,
          String(c?.stateName || c?.label || "").length * 10 + 30,
        ),
        height: 54,
      }),
      animationCapabilities: [
    ...
    this.register({
      ...
      category: "state",
      semanticMeaning:
        "Conditional decision point evaluating predicates to determine alternative branch paths.",
      supportedProperties: [
        "condition",
        "selectedOutcomeId",
        "possibleOutcomes",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(90, String(c?.condition || "").length * 8 + 30),
        height: 70,
      }),
    ...
    this.register({
      ...
      category: "state",
      semanticMeaning:
        "Presently active, focused, or evaluating operational state.",
    ...
    this.register({
      ...
      category: "state",
      semanticMeaning:
        "Exceptional error, timeout, crash, or invariant breach state requiring recovery.",
    ...
    this.register({
      ...
      category: "state",
      semanticMeaning:
        "Restorative or compensation state reverting or repairing a prior failure.",
    ...
    this.register({
      ...
      category: "data",
      semanticMeaning:
        "Structured tabular dataset with named schema headers, columns, and rows.",
      supportedProperties: [
        "tableName",
        "headers",
        "rows",
    ...
    this.register({
      ...
      category: "data",
      semanticMeaning:
        "Relational, document, or key-value storage engine maintaining ACID records.",
    ...
    this.register({
      ...
      category: "data",
      semanticMeaning:
        "A single tabular record, tuple, or structured entity entry in a dataset.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(
          160,
          (c?.fields ? Object.keys(c.fields).length : 2) * 80,
        ),
        height: 36,
      }),
      animationCapabilities: ["CREATE", "REMOVE", "MUTATE", "HIGHLIGHT"],
    ...
    this.register({
      ...
      category: "data",
      semanticMeaning:
        "Schema column header or table title defining attribute names and types.",
    ...
    this.register({
      ...
      category: "data",
      semanticMeaning:
        "Individual data cell holding a single scalar value or address.",
    ...
    this.register({
      ...
      semanticMeaning:
        "Stack activation record representing an active function call, parameters, and scope.",
      supportedProperties: [
        "functionName",
        "parameters",
        "returnValue",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(140, String(c?.functionName || "").length * 10 + 40),
        height: 44,
      }),
      animationCapabilities: ["CREATE", "REMOVE", "MUTATE", "HIGHLIGHT"],
      connectorCapabilities: {
    ...
    this.register({
      ...
      category: "computation",
      semanticMeaning:
        "Execution stack frame containing local variables and return address.",
    ...
    this.register({
      ...
      category: "computation",
      semanticMeaning:
        "Operating system process with PID, memory address space, and state.",
    ...
    this.register({
      ...
      category: "computation",
      semanticMeaning:
        "FIFO buffer or task queue holding jobs pending scheduling or dispatch.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(140, (c?.items?.length || 3) * 40),
        height: 50,
      }),
    ...
    this.register({
      ...
      category: "memory",
      semanticMeaning:
        "Allocated memory chunk, heap buffer, or hardware register.",
    ...
    this.register({
      ...
      category: "memory",
      semanticMeaning:
        "Reference pointing to an address, node, or pivot in a data structure.",
    ...
    this.register({
      ...
      semanticMeaning:
        "Mathematical expression, equality, recurrence relation, or proof step.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(160, String(c?.formula || "").length * 12 + 40),
        height: 50,
      }),
    ...
    this.register({
      ...
      category: "science",
      semanticMeaning:
        "Directional light ray, wave front, or particle path through media.",
    ...
    this.register({
      ...
      category: "science",
      semanticMeaning:
        "Physical discrete particle, atom, molecule, or electron.",
    ...
    this.register({
      ...
      category: "timeline",
      semanticMeaning:
        "Linear chronological track representing sequence of state progressions.",
    ...
    this.register({
      ...
      category: "timeline",
      semanticMeaning:
        "Discrete milestone or event along a chronological timeline.",
    ...
    this.register({
      ...
      category: "timeline",
      semanticMeaning:
        "High-level conceptual phase enclosing multiple transformation events.",
    ...
    this.register({
      ...
      category: "annotation",
      semanticMeaning:
        "Prominent pedagogical callout highlighting what changed, why, and what to notice.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(
          160,
          Math.min(260, String(c?.text || "").length * 7 + 40),
        ),
        height: Math.max(
          60,
          Math.ceil(String(c?.text || "").length / 32) * 22 + 36,
        ),
      }),
      animationCapabilities: ["CREATE", "REMOVE", "MUTATE", "HIGHLIGHT"],
      connectorCapabilities: {
    ...
    this.register({
      ...
      category: "annotation",
      semanticMeaning:
        "Compact status or invariant verification badge attached to an entity.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(60, String(c?.text || "").length * 8 + 20),
        height: 26,
      }),
    ...
    this.register({
      ...
      category: "annotation",
      semanticMeaning:
        "Verified executable correctness badge confirming invariant satisfaction.",
      ...
      dynamicSizingRules: (c) => ({
        width: Math.max(90, String(c?.statement || "").length * 8 + 24),
        height: 28,
      }),
