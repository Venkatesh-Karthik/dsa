...
export {
  ...
  ALL_CAN_RENDER_CAPABILITIES,
  type VisualCapabilityToken,
...
export class VisualCapabilityRegistry {
  ...
  private static initialize(): void {
    const list: VisualCapabilityDescriptor[] = [
      // 1. Structural Primitives
      {
        ...
        preferredCompositionStrategies: [
          "structural",
          "pipeline",
          "causal",
          "network",
      ...
      },
      {
        ...
        shape: "ellipse",
        semanticAffordance:
          "Compact symmetric node for trees, graphs, or atomic units",
        sizing: {
          defaultWidth: 70,
          defaultHeight: 70,
          minWidth: 50,
      ...
      },
      {
        ...
        shape: "ellipse",
        semanticAffordance:
          "Hierarchical tree node with parent/child connectivity",
        sizing: {
          defaultWidth: 70,
          defaultHeight: 70,
          minWidth: 60,
      ...
      },
      {
        ...
        shape: "container",
        semanticAffordance:
          "Grouping boundary or enclosing context holding child entities",
        sizing: {
          defaultWidth: 260,
          defaultHeight: 180,
          minWidth: 160,
      ...
      // 2. Tabular & Structured Data
      {
        ...
        shape: "table",
        semanticAffordance:
          "Structured relational or tabular collection of records with rows/columns",
        sizing: {
          defaultWidth: 260,
          defaultHeight: 140,
          minWidth: 180,
      ...
      },
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Single indexed element within a sequential array/vector",
        sizing: {
          defaultWidth: 60,
          defaultHeight: 40,
          minWidth: 44,
      ...
      },
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Structured tuple or entity record with field-value pairs",
        sizing: {
          defaultWidth: 200,
          defaultHeight: 70,
          minWidth: 140,
      ...
      // 3. Interaction & Multi-Party Communication
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Autonomous communicating entity or protocol participant with lifeline",
        sizing: {
          defaultWidth: 120,
          defaultHeight: 60,
          minWidth: 90,
      ...
      },
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Initiating or consuming endpoint in distributed communication",
        sizing: {
          defaultWidth: 120,
          defaultHeight: 60,
          minWidth: 90,
      ...
      },
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Responding or processing endpoint in distributed communication",
        sizing: {
          defaultWidth: 120,
          defaultHeight: 60,
          minWidth: 90,
      ...
      },
      {
        ...
        shape: "pill",
        semanticAffordance:
          "Communicated payload, datagram, or message traveling between endpoints",
        sizing: {
          defaultWidth: 100,
          defaultHeight: 36,
          minWidth: 70,
      ...
      // 4. State & Decision
      {
        ...
        shape: "pill",
        semanticAffordance:
          "Discrete system state, phase, or lifecycle milestone",
        sizing: {
          defaultWidth: 120,
          defaultHeight: 46,
          minWidth: 80,
      ...
      // 5. Memory & Storage
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Memory allocation block, variable slot, or memory register",
        sizing: {
          defaultWidth: 140,
          defaultHeight: 44,
          minWidth: 100,
      ...
      },
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "LIFO call stack activation frame or execution context",
        sizing: {
          defaultWidth: 150,
          defaultHeight: 40,
          minWidth: 110,
      ...
      },
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Pointer-connected linear node containing value and address link",
        sizing: {
          defaultWidth: 80,
          defaultHeight: 40,
          minWidth: 60,
      ...
      // 6. Computation & Process
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Computational function, transformation engine, or processor",
        sizing: {
          defaultWidth: 130,
          defaultHeight: 56,
          minWidth: 90,
      ...
      // 7. Mathematics & Science
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Mathematical formula, governing equation, or physical law",
        sizing: {
          defaultWidth: 160,
          defaultHeight: 44,
          minWidth: 100,
      ...
      // 8. Annotation & Auxiliary
      {
        ...
        shape: "rectangle",
        semanticAffordance:
          "Contextual educational note anchored to an element without covering it",
        sizing: {
          defaultWidth: 180,
          defaultHeight: 56,
          minWidth: 120,
  ...
  public static resolveMatchingCapability(
    ...
    const query = `${semanticRole || ""} ${entityType || ""} ${label || ""}`
      .toLowerCase()
      .trim();
    ...
    if (
      /\b(process|function|processor|alu|worker|transformer)\b/i.test(query)
    ) {
