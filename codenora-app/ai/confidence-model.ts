...
export const CONFIDENCE_KNOWN = createConfidence(
  1.0,
  "KNOWN",
  "Directly verified",
  "axiom",
);
export const CONFIDENCE_DERIVED = createConfidence(
  0.95,
  "DERIVED",
  "Deterministically computed",
  "computation",
);
export const CONFIDENCE_INFERRED = createConfidence(
  0.85,
  "INFERRED",
  "Semantically inferred",
  "heuristics",
);
export const CONFIDENCE_ASSUMED = createConfidence(
  0.7,
  "ASSUMED",
  "Standard convention assumed",
  "convention",
);
export const CONFIDENCE_UNCERTAIN = createConfidence(
  0.4,
  "UNCERTAIN",
  "Ambiguous or partially specified",
  "heuristics",
);
