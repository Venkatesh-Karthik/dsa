...
import { aiTeachingBackendPlugin } from "./ai/backend/vite-plugin";
export default defineConfig(({ mode }) => {
  ...
  if (combinedEnv.NVIDIA_MODEL && !combinedEnv.NVIDIA_MODEL.includes("super-120b")) {
  ...
  return {
    ...
    plugins: [
      aiTeachingBackendPlugin(),
      Sitemap({
        hostname: "https://codenora.com",
        outDir: "build",
        changefreq: "monthly",
      ...
      envVars.VITE_APP_DISABLE_CHECKER === "true"
        ? undefined
        : checker({
            typescript: envVars.VITE_APP_ENABLE_TS_CHECKER === "true",
            eslint:
      ...
      VitePWA({
        ...
        manifest: {
          ...
          name: "Codenora",
          description:
            "Codenora is an AI-powered visual learning workspace where you can understand concepts and code through interactive visual explanations.",
          icons: [
            {
